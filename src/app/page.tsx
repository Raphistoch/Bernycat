...
const technicalSpecs = [
    {
        ...
        label: 'Longueur',
        value: '4.87 m',
        description: 'Longueur de coque',
    },
    {
        icon: Ruler,
        label: 'Largeur',
        value: '2.00 m',
        description: 'Largeur maximum',
    },
    {
        icon: Weight,
        label: 'Poids',
        value: '250 kg',
        description: 'Déplacement à vide',
    },
    {
        icon: Wind,
        label: 'Grand-voile',
        value: '13.50 m²',
        description: 'Voile type Houari',
    },
    {
        icon: Users,
        label: 'Équipage',
        value: '4 adultes',
        description: 'Poids max 300 kg',
    },
    {
        icon: Waves,
        label: 'Tirant d\'eau',
        value: '0.20-1.00 m',
        description: 'Dérive aluminium 25 kg',
    },
]
